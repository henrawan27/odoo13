...
class AccountAccount(models.Model):
    ...
    def get_deferred_revenue_accounts_type(self):
        return self.env.ref('account.data_account_type_current_liabilities') + self.env.ref('account.data_account_type_non_current_liabilities') + self.env.ref('mpn_chart_template_fix.data_account_type_pendapatan_diterima_dimuka')
