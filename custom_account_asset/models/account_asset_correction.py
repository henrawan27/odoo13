...
class MoveAssetCorrectionLine(models.Model):
    ...
    account_id = fields.Many2one('account.account', string='Account', required=True, domain="[('company_id', '=', company_id), ('user_type_id.name', 'in', ['Fixed Assets', 'Expenses', 'Aset Tetap', 'Penyusutan', 'Beban Penyusutan', 'Hutang Usaha'])]")
