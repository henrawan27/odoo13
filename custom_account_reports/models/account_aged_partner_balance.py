...
class report_account_aged_partner(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        columns = [
            ...
            {'name': _("Label"), 'class': '', 'style': 'text-align:center; white-space:nowrap;'},
            ...
            if 'partner_%s' % (values['partner_id'],) in options.get('unfolded_lines'):
                for line in amls[values['partner_id']]:
                    ...
                    vals = {
                        ...
                        'columns': [{'name': v} for v in [format_date(self.env, aml.date_maturity or aml.date), aml.journal_id.code, aml.name, format_date(self.env, aml.expected_pay_date)]] +
